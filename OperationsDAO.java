...
public class OperationsDAO implements Comparable{
	...
	public void listAllFiles(String path) {
		...
		if(files != null && files.length > 0) {
			...
			SortedSet<String>filesList = new TreeSet<>(Arrays.asList(files)); 
			System.out.println("The Files in "+ dir.getAbsolutePath() + " are displayed in ascending order as below: \n");
